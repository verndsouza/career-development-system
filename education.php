...
if ($_SERVER["REQUEST_METHOD"] == "POST" && (isset($_POST["prevRole"]) || isset($_POST["nextExp"]) || isset($_POST["EdRole"]) || isset($_POST["EdExp"]) || isset($_POST["EdSkill"])))
{
  ...
  if($i == 0)
  {
    ...
    if(isset($_POST["prevRole"]) || isset($_POST["EdRole"]))
    {
      header('Location: role.php');
    }

    if(isset($_POST["EdExp"]) || isset($_POST["nextExp"]))
    {
      header('Location: experience.php');
    }

    if(isset($_POST["EdSkill"]))
    {
...
if ($_SERVER["REQUEST_METHOD"] == "GET" || $i == 1)
{
  ...
  echo'<section>
    ...
    <button class="btn btn-defaul " name="EdRole" value="EdRole" type="submit">Desired Role</button>&nbsp&nbsp&nbsp
    <button style="background-color: #00ffcc;" class="btn btn-defaul " type="button" name="Edu" value="Edu"/>Education</button>&nbsp&nbsp&nbsp
    <button class="btn btn-defaul " type="submit" name="EdExp" value="EdExp"/>Experience</button>
    &nbsp&nbsp&nbsp
    <button class="btn btn-defaul " type="submit" name="EdSkill" value="EdSkill"/>&nbsp&nbsp&nbsp&nbsp&nbsp Skills &nbsp&nbsp&nbsp&nbsp&nbsp</button>
    <br/>
    <br/>
    ...
    $sql = "SELECT * FROM education_temp";
    ...
    <br><br></div>
    <button class="btn btn-defaul" type="submit" name="prevRole" value="prevRole"/>&lt&ltPrev</button>
    &nbsp&nbsp&nbsp<button class="btn btn-defaul" type="submit" name="nextExp" value="nextExp"/>Next>><br/>
    </div>
    </form>
    </div>
    </section>';
