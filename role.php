...
if ($_SERVER["REQUEST_METHOD"] == "POST" && (isset($_POST["nextEdu"]) || isset($_POST["REdu"]) || isset($_POST["RExp"]) || isset($_POST["RSkill"])))
{
  //validate Role Form
  ...
  if($i == 0)
  {
    ...
    if(isset($_POST["nextEdu"])|| isset($_POST["REdu"]))
    {
...
if ($_SERVER["REQUEST_METHOD"] == "GET" || $i == 1)
{
  ...
  echo'<section>
    ...
    <button style="background-color: #00ffcc;" class="btn btn-defaul " name="role" value="role" type="submit">Desired Role</button>&nbsp&nbsp&nbsp
    <button class="btn btn-defaul" type="submit" name="REdu" value="REdu">Education</button>&nbsp&nbsp&nbsp
    <button class="btn btn-defaul" type="submit" name="RExp" value="RExp">Experience</button>
    &nbsp&nbsp&nbsp
    <button class="btn btn-defaul" type="submit" name="RSkill" value="RSkill">&nbsp&nbsp&nbsp&nbsp&nbspSkills&nbsp&nbsp&nbsp&nbsp&nbsp</button>
    <br/>
      <br/><br/>
  ...
  <br/>
  <button class="btn btn-defaul" type="submit" name="nextEdu" value="nextEdu"/>Next>><br/>
  </form>
  </section>';
}
